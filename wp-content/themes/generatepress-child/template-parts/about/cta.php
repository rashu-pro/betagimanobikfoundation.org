<?php
/**
 * Template part: About Us — CTA section
 *
 * @package generatepress-child
 */

$cta_image_raw = rwmb_meta( 'bmf_about_cta_image' );
$cta_image     = is_array( $cta_image_raw ) ? ( $cta_image_raw['full_url'] ?? $cta_image_raw['sizes']['large']['url'] ?? '' ) : (string) $cta_image_raw;
$cta_head      = rwmb_meta( 'bmf_about_cta_head' );
$cta_body      = rwmb_meta( 'bmf_about_cta_body' );
$cta_btn1_text = rwmb_meta( 'bmf_about_cta_btn1_text' );
$cta_btn1_url  = rwmb_meta( 'bmf_about_cta_btn1_url' );
$cta_btn2_text = rwmb_meta( 'bmf_about_cta_btn2_text' );
$cta_btn2_url  = rwmb_meta( 'bmf_about_cta_btn2_url' );
