 ...
 *
 * Renders the blog listing page — no sidebar, full-width card grid.
 * Matches the card style from template-parts/home/blog.php.
 *
...
<main id="primary" class="site-main">
	...
	<!-- Page Hero -->
	<div class="bg-primary-dark py-14">
		<div class="container mx-auto px-4 text-center">
			<h1 class="text-4xl font-bold text-white mb-3">
				<?php esc_html_e( 'ব্লগ ও খবর', 'generatepress-child' ); ?>
			</h1>
			<nav class="text-sm text-green-200" aria-label="<?php esc_attr_e( 'Breadcrumb', 'generatepress-child' ); ?>">
				<a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="hover:text-white transition">
					<?php esc_html_e( 'হোম', 'generatepress-child' ); ?>
				</a>
				<span class="mx-2">›</span>
				<span><?php esc_html_e( 'ব্লগ', 'generatepress-child' ); ?></span>
			</nav>
		</div>
	</div>
